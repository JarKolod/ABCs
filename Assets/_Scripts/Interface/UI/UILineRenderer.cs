...
/// <summary>
/// UI Line Renderer made by Radishmouse22 on GitHub
/// </summary>
...
public class UILineRenderer : Graphic
{
    ...
    [SerializeField] private bool isChartCentred = true;
    ...
    protected override void OnPopulateMesh(VertexHelper vh)
    {
        ...
        for (int i = 0; i < points.Length - 1; i++)
        {
            ...
            // These two triangles create the bevelled edges
    ...
    {
        Vector3 offset = isChartCentred ? (rectTransform.sizeDelta / 2) : Vector2.zero;
